 ...
 */
$invert_lite_pre_options = ( get_option('invert_lite') != '' ) ? get_option( 'invert_lite' ) : false ;

if ( $invert_lite_pre_options) {

	require_once(get_template_directory() . '/includes/invert-options-migrate.php');
