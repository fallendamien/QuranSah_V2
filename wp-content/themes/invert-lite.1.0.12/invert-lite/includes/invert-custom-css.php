...
.iconbox-content-link:hover,.page #content .title, .single #content .title,#content .post-heading,.childpages li ,.fullwidth-heading,.comment-meta a:hover,#respond .required{color: <?php if(isset($bg_color)){ echo $bg_color; } ?>;} 
